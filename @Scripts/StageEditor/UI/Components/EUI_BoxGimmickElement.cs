...
public class EUI_BoxGimmickElement : UI
{
    #region Properties

    public EUI_BoxGimmickEditor Editor { get; set; }
    public BoxGimmickData Data { get; private set; }
    ...
    public void Set(EUI_BoxGimmickEditor editor, BoxGimmickData data) {
        Initialize();
    ...
    private void OnButtonEdit() {
        Main.UI.OpenPanel<EUI_Panel_BoxGimmickProperties>().Set(this);
    }
